...
categories:
  ...
  - LaTeX
date: "2024-02-17"
slug: "making-pretty-pdf-quarto-typst"
draft: false
excerpt: ""
layout: blog-single
subtitle: ""
...
`! Undefined control sequence` - an error message you are probably unfortunate enough to be familiar with if you've ever tried to make a PDF using LaTeX. 

Typst is ..., and with the [latest release of Quarto](https://quarto.org/docs/blog/posts/2024-01-24-1.4-release/) 
...
added into existing extension as an additional format

I started by looking at ... [](https://github.com/quarto-ext/typst-templates/tree/main/dept-news)

- try to figure out what each line does by deleting or editing it
- take out anything I don't want
- add in some new bits I do need
